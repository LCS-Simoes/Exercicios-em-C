...
void buscar(No *novo)
{
    ...
    while (atual != NULL)
    {
        if (strcmp(atual->aplicativo.aplicativo, nome) == 0)
        {
...
void atualizar_contato(No *novo)
{
    char nome[80];
    printf("Digite o nome que deseja ser atualizado: ");
    fgets(nome,80,stdin);
    ...
    while(atual != NULL)
    {
        if(strcmp(atual->contato.nome, nome) == 0 )
        {
            ...
            printf("\nEmail: ");
            fgets(atual->contato.email, 80, stdin);
            return; // Se eu nao retornar a funcao ele ira exibir a mensagem de usuario nao encontrado
...
int main()
{
    ...
    do
    {
        ...
        case 4:
            ...
            break;
        case 5:
            atualizar_contato(novo);
            break;
        case 6:
            ultimo_contato(novo);
            break;
        default:
            printf("Opcao digitada e incorreta");
        }
